...
public class HelpOthers {
    ...
    public static void main(String[] args) {
        ...
        List<String> xuanxiangList= new ArrayList();
        List<String> daanList= new ArrayList();

        for (String everyLine : results) {
            String timu = "";
            String xuanxiang = "";
            String daan = "";
        ...
        for(int i = 0;i<timuList.size();i++){
            timuList.get(i).replaceAll("（",daanList.get(i));
     ...
     static String txt = "1、  搞好设备管理工作，必须坚持专管与(   )相结合。 \n" +
            ...
            "162、划线时，用来确定工件各部位尺寸、几何形状及相对位置的线，称为( )线。     " +
             "A.原始   B.零位    C.基准            正确答案：C\n" +
               
            "163、划线时V型块儿是用来安装（ ）工件的。\n" +
               
            "A.圆柱形  B.圆锥形  C.大型   D.大型   正确答案：A\n" +
               
            "164、机床空运转试验,在主轴轴承达到稳定温度时,滚动轴承的温度不得超过(    )。  " +
            ...
            "173、机械在承受压力大、运动速度慢、精度要求低的场合，应选用(   )的润滑油。 " +
             "  A.粘度大    B.粘度小   C.蒸发点高            正确答案：A\n" +
